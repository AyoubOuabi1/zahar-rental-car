...
export default function ReservationSection() {
    return (
        <section style={{
            backgroundImage: 'url(https://cristallinecar.com/assets/img/facts-section.jpg)',
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <motion.div
                        ...
                        className="bg-blue-400 p-8 rounded-lg shadow-lg max-w-lg mx-auto"
                    >
                        <ReservationForm />
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="hidden md:flex flex-col items-center justify-center text-white max-w-md mx-auto text-center"
                    >
